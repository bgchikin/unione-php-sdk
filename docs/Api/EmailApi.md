...
While sending you can provide substitutions (merge tags), use a template, turn on read or click tracking, etc.  Restrictions: * maximum request size is 10 MB * maximum number of recipients is 500 * The symbol '/' is not allowed in attachment names  If the list of recipients contains invalid, non-existent, duplicate, or unsubscribed emails, those emails will be returned in the output parameter failed_emails, and the email will be sent to all other valid emails addresses. If all the emails addresses fall into failed_emails, sending will not be carried out and API error 204 will be returned.
...
$emailSendRequest = new \UniOne\Model\EmailSendRequest(); // \UniOne\Model\EmailSendRequest
...
------------- | ------------- | ------------- | -------------
 **emailSendRequest** | [**\UniOne\Model\EmailSendRequest**](../Model/EmailSendRequest.md)|  |
...
$emailSubscribeRequest = new \UniOne\Model\EmailSubscribeRequest(); // \UniOne\Model\EmailSubscribeRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailSubscribeRequest** | [**\UniOne\Model\EmailSubscribeRequest**](../Model/EmailSubscribeRequest.md)|  |
