...
$emailValidationSingleRequest = new \UniOne\Model\EmailValidationSingleRequest(); // \UniOne\Model\EmailValidationSingleRequest
...
------------- | ------------- | ------------- | -------------
 **emailValidationSingleRequest** | [**\UniOne\Model\EmailValidationSingleRequest**](../Model/EmailValidationSingleRequest.md)|  |
