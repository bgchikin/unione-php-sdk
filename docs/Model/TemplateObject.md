...
------------ | ------------- | ------------- | -------------
**id** | **string** | Template unique identifier. If you omit the \&quot;id\&quot; field then new template will be created. If you specify the \&quot;id\&quot; field, the system will try to find a template with the specified id and edit it. | [optional]
...
**body** | [**\UniOne\Model\BodyObject**](BodyObject.md) |  | [optional]
