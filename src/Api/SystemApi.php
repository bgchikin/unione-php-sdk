...
class SystemApi
{
     ...
     */
    public function systemInfo($body)
    {
        list($response) = $this->systemInfoWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function systemInfoWithHttpInfo($body)
    {
        $request = $this->systemInfoRequest($body);
     ...
     * @return Promise
     */
    public function systemInfoAsync($body)
    {
        return $this->systemInfoAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return Promise
     */
    public function systemInfoAsyncWithHttpInfo($body)
    {
     ...
     */
    public function systemInfoRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling systemInfo'
            );
        }
