...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://us1.unione.io/en/transactional/api/v1';
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://us1.unione.io/en/transactional/api/v1",
                "description" => "UniOne USA & Canada Instance",
            ],
            [
                "url" => "https://eu1.unione.io/en/transactional/api/v1",
                "description" => "UniOne European Instance",
            ]
        ];
    }
