...
class EmailValidationSingle200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets result
     *
     * @param string $result Possible statuses: <ul><li>\"valid\" - the address is valid, <li>\"invalid\" - the address is invalid, <li>\"suspicious\" - the address looks suspicious, <li>\"unknown\" - could not perform validation, the domain’s mail server has not responded within the time limit.</ul>
     *
     * @return self
     */
