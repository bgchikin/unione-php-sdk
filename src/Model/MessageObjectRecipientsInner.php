...
class MessageObjectRecipientsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageObject_recipients_inner';
    ...
    */
     ...
     * Sets metadata
     *
     * @param array<string,string>|null $metadata Object for passing the metadata, such as \"key\": \"value\". Max key quantity: 10. Max key length: 64 symbols. Max value length: 1024 symbols. The metadata is returned by [webhook](#webhook) and [event-dump](#event-dump) methods. If you pass strign up to 128 bit with \"campaign_id\" field name (name is configurable thru support), it will be considered as campaign identifier in statistics.
     *
     * @return self
     */
