...
class WebhookSetJsonPostRequestEventsByUserInnerEventsInnerEventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_webhook_set_json_post_request_events_by_user_inner_events_inner_event_data';
    ...
    */
     ...
     * Sets jobId
     *
     * @param string|null $jobId Job identifier returned earlier by [email/send](#email-send) method. Property exists only if event_name=\"transactional_email_status\".
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,string>|null $metadata Metadata passed in [email/send](#email-send) method in recipients.metadata or global_metadata properties. This property exists only if event_name=\"transactional_email_status\".
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getSMTPBlocksCount()
    {
     ...
     * @return self
     */
    public function setSMTPBlocksCount($sMTPBlocksCount)
    {
